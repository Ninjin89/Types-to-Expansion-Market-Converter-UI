...
4. Load your `types.xml` file by pressing the ``Load Types XML`` Button, the name of the file doesnt matter.
   ```
   You can find the types.xml in your mods folder in your mpmissions folder.
   ```
5. Load your `.json` file by pressing the `Load Market JSON` Button, the name of the file doesnt matter.
   ```
   You can find the .json in your Server profiles folder for example
...
[product-screenshot]: https://github.com/Ninjin89/Types-to-Expansion-Market-Converter-UI/blob/main/preview.png
